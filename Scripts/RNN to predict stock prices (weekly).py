...
U11_model.add(SimpleRNN(128, input_shape=(look_back,U11_num_input_feature), return_sequences = True))
U11_model.add(SimpleRNN(64, input_shape=(look_back,U11_num_input_feature), return_sequences = False))
...
C38U_model.add(SimpleRNN(128, input_shape=(look_back,C38U_num_input_feature), return_sequences = True))
C38U_model.add(SimpleRNN(64, input_shape=(look_back,C38U_num_input_feature), return_sequences = False))
...
C38U_checkpoint = ModelCheckpoint('./C38U_best_weights_model.hdf5', monitor='val_loss',
                             verbose=1, save_best_only=True, mode='min')
C38U_model_trained = C38U_model.fit(C38U_trainX, C38U_trainY, batch_size = len(C38U_trainX),
                                    epochs = 10000, validation_split=0.30, shuffle = False,
...
E5H_model.add(SimpleRNN(128, input_shape=(look_back,E5H_num_input_feature), return_sequences = True))
E5H_model.add(SimpleRNN(64, input_shape=(look_back,E5H_num_input_feature), return_sequences = False))
...
E5H_checkpoint = ModelCheckpoint('./E5H_best_weights_model.hdf5', monitor='val_loss',
                             verbose=1, save_best_only=True, mode='min')
E5H_model_trained = E5H_model.fit(E5H_trainX, E5H_trainY, batch_size = len(E5H_trainX),
                                  epochs = 10000, validation_split=0.30, shuffle = False,
